...
CFLAGS = -Wall -O2 -c -march=armv6 -msoft-float -fPIC -mapcs-frame -marm -ffreestanding -nostdlib $(INC_DIRS) -DCPU_SPEED=${F_CLK} -DTIME_SLICE=${TIME_SLICE} -DLITTLE_ENDIAN -DKERN_VER=\"$(KERNEL_VER)\" $(CFLAGS_STRIP) # -fshort-double
