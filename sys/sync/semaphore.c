 ...
 * 
 * @return HF_OK on success and HF_ERROR if the semaphore could not be allocated in
 ...
 * @param s is a pointer to a semaphore.
 * 
 * @return HF_OK on success and HF_ERROR if the semaphore could not be removed from memory.
 */
