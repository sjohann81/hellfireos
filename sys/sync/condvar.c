 ...
 *
 * @return HF_OK on success and HF_ERROR if the condition variable could not be allocated in memory.
 */
 ...
 * @param c is a pointer to a condition variable.
 * 
 * @return HF_OK on success and HF_ERROR if the condition variable could not be
 * removed from memory.
 */
