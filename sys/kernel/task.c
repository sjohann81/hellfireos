 ...
 * 
 * @return task id if the task is found and HF_INVALID_NAME otherwise.
 */
 ...
 * @param id is a task id number.
 * 
 * @return task state the task if found (TASK_IDLE, TASK_READY, TASK_RUNNING, TASK_BLOCKED, TASK_DELAYED or TASK_WAITING) and HF_INVALID_ID otherwise.
 */
 ...
 * @param id is a task id number.
 * 
 * @return jobs executed by the task if found and HF_INVALID_ID otherwise.
 */
 ...
 * @param id is a task id number.
 * 
 * @return deadlines missed by the task if found and HF_INVALID_ID otherwise.
 */
 ...
 * 
 * @return task id if the task is created, HF_EXCEED_MAX_NUM if the maximum number of tasks in the system
 * is exceeded, HF_INVALID_PARAMETER if impossible RT parameters are specified or HF_OUT_OF_MEMORY if
 ...
 * @param id is a task id number.
 * 
 * @return HF_OK on success, HF_INVALID_ID if the referenced task does not exist or HF_ERROR if the task is already in the blocked state.
 * 
 ...
 * @param id is a task id number.
 * 
 * @return HF_OK on success, HF_INVALID_ID if the referenced task does not exist or HF_ERROR if the task is not in the blocked state.
 * 
 ...
 * @param id is a task id number.
 * 
 * @return HF_OK on success or HF_INVALID_ID if the referenced task does not exist.
 * 
